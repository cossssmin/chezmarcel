      ...
      <section class="sm:pt-32" v-if="$page.camera.cta">
        <div class="max-w-5xl mx-auto px-8">
          <div class="flex flex-col text-center">
            ...
            <a href="#top" v-html="$page.camera.cta[0].btnText" class="scroll-to mt-8 border border-blue-500 self-center font-sans transition duration-150 text-blue-500 hover:bg-blue-500 hover:text-white hover:shadow-md rounded px-6 py-4 no-underline z-10" />
          </div>
        </div>
      </section>
