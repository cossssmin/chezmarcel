<nav class="nav flex items-center fixed w-full bg-black z-30 h-20 pin-r pin-t">
    <div class="container flex items-center justify-between">
        ...
        <ul id="menu" class="absolute lg:relative bg-black hidden list-reset lg:flex md:justify-around lg:p-1 md:w-1/3 mt-20 lg:mt-0 pin-r pin-t pl-4 text-right w-48">
            <li>
                <a href="{{ $page->baseUrl }}/rooms/" class="inline-block text-sm sm:text-base p-1">Rooms</a>
            </li>
            <li>
                <a href="{{ $page->baseUrl }}/facilities/" class="inline-block text-sm sm:text-base p-1">Facilities</a>
            </li>
            <li>
                <a href="{{ $page->baseUrl }}/gallery/" class="inline-block text-sm sm:text-base p-1">Gallery</a>
            </li>
            <li>
                <a href="{{ $page->baseUrl }}/contact/" class="inline-block text-sm sm:text-base p-1">Contact</a>
            </li>
            <li class="hidden lg:block lg:fixed pin-r">
                <a href="{{ $page->baseUrl }}/" class="inline-block text-sm sm:text-base p-1">RO</a>
            </li>
            <li class="block lg:hidden lg:fixed pin-r">
                <a href="{{ $page->baseUrl }}/" class="inline-block text-sm sm:text-base p-1">Română</a>
            </li>
        </ul>
    </div>
