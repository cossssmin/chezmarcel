<section class="bg-grey-lightest pb-10 sm:pb-0 xl:py-16">
    <div class="container flex flex-col items-center text-center lg:-mb-32 mb-16 sm:-mb-8 xl:-mb-72">
        <h4 class="font-light text-2xl sm:text-4xl text-black mb-4">{{ $title ?? 'Rezervări simple și rapide' }}</h4>
